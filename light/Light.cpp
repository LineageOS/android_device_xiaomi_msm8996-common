...
Light::Light(std::ofstream&& lcd_backlight, std::ofstream&& button_1_backlight,
    ...
    mButton1Backlight(std::move(button_1_backlight)),
    mButton2Backlight(std::move(button_2_backlight)),
    mButton3Backlight(std::move(button_3_backlight)),
...
void Light::setButtonsBacklight(const LightState& state) {
    ...
    mButton1Backlight << brightness << std::endl;
    mButton2Backlight << brightness << std::endl;
    mButton3Backlight << brightness << std::endl;
}
