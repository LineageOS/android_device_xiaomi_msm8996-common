...
public class ButtonSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (!PackageManagerUtils.isAppInstalled(getContext(), "com.cyanogenmod.pocketmode")) {
            fingerprintCategory.removePreference(mPocketModePreference);
            mPocketModePreference = null;
        }
    }
    ...
    public void addPreferencesFromResource(int preferencesResId) {
        ...
        mPocketModePreference = (SwitchPreference) findPreference(Constants.FP_POCKETMODE_KEY);
