...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.camera.raw.xml:vendor/etc/permissions/android.hardware.camera.raw.xml \
    ...
    frameworks/native/data/etc/android.software.print.xml:vendor/etc/permissions/android.software.print.xml \
    ...
    frameworks/native/data/etc/com.nxp.mifare.xml:vendor/etc/permissions/com.nxp.mifare.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/audio_output_policy.conf:vendor/etc/audio_output_policy.conf \
    $(LOCAL_PATH)/audio/audio_policy_configuration.xml:vendor/etc/audio_policy_configuration.xml \
    $(LOCAL_PATH)/audio/listen_platform_info.xml:system/etc/listen_platform_info.xml \
    $(LOCAL_PATH)/audio/sound_trigger_mixer_paths.xml:vendor/etc/sound_trigger_mixer_paths.xml \
    $(LOCAL_PATH)/audio/sound_trigger_mixer_paths_wcd9330.xml:vendor/etc/sound_trigger_mixer_paths_wcd9330.xml \
    $(LOCAL_PATH)/audio/sound_trigger_platform_info.xml:vendor/etc/sound_trigger_platform_info.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media_profiles.xml:vendor/etc/media_profiles.xml
...
# Seccomp policy
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/seccomp_policy/mediacodec.policy:vendor/etc/seccomp_policy/mediacodec.policy
